...
var fields = (function () {
	var chance = new Cards('Šance', [
		...
		moveToNearestRail,
		goToJail,
		goTo.bind(this, 11), // Go to North Carolina.
		goTo.bind(this, 0), // Go to start.
		goTo.bind(this, 5), // Go to Illino.
	...
	return [
		...
		{name: 'Jdi do vězení', visit: goToJail},
